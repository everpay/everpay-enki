...
const PayoutsApiPage = () => (
  <div className="max-w-4xl mx-auto space-y-10">
    ...
    <ApiEndpoint method="POST" path="/v2/payouts" title="Create a Payout" description="Send funds to a merchant's bank account."
      params={[
    ...
    />
    <ApiEndpoint method="GET" path="/v2/payouts" title="List Payouts" description="Retrieve a paginated list of payouts."
      params={[{ name: "status", type: "string", required: false, desc: "pending, paid, failed" }]}
      code={{
        curl: `curl "https://api.everpayinc.com/v2/payouts?status=paid" \\\n  -H "Authorization: Bearer sk_test_your_key"`,
