...
const PaymentsApiPage = () => {
  return (
    <div className="max-w-4xl mx-auto space-y-10">
      ...
      <ApiEndpoint method="POST" path="/v1/payments" title="Create a Payment" description="Create a new payment intent and charge the customer."
        params={[
      ...
      <ApiEndpoint method="GET" path="/v1/payments" title="List Payments" description="Retrieve a paginated list of payments."
        params={[
        ...
        code={{
          curl: `curl https://api.everpayinc.com/v1/payments?limit=10 \\\n  -H "Authorization: Bearer sk_test_your_key"`,
      ...
      <ApiEndpoint method="POST" path="/v1/payments/:id/capture" title="Capture a Payment" description="Capture a previously authorized payment."
        params={[{ name: "amount", type: "integer", required: false, desc: "Partial capture amount (defaults to full)" }]}
        code={{
          curl: `curl -X POST https://api.everpayinc.com/v1/payments/pay_abc123/capture \\\n  -H "Authorization: Bearer sk_test_your_key" \\\n  -d '{"amount": 3000}'`,
      ...
      <ApiEndpoint method="POST" path="/v1/payments/:id/refund" title="Refund a Payment" description="Issue a full or partial refund."
        params={[
