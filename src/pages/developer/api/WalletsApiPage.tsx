...
const WalletsApiPage = () => (
  <div className="max-w-4xl mx-auto space-y-10">
    ...
    <ApiEndpoint method="POST" path="/v1/wallets" title="Create a Wallet" description="Create a new digital wallet."
      params={[
      ...
      code={{
        curl: `curl -X POST https://api.everpayinc.com/v1/wallets \\\n  -H "Authorization: Bearer sk_test_your_key" \\\n  -d '{"user_id": "usr_abc123", "currency": "usd"}'`,
      ...
      response={`{\n  "id": "wal_abc123",\n  "balance": 0,\n  "currency": "usd",\n  "status": "active"\n}`}
    />
    <ApiEndpoint method="POST" path="/v1/wallets/transfer" title="Transfer Between Wallets" description="Move funds between two wallets."
      params={[
      ...
      code={{
        curl: `curl -X POST https://api.everpayinc.com/v1/wallets/transfer \\\n  -H "Authorization: Bearer sk_test_your_key" \\\n  -d '{"from_wallet_id": "wal_abc", "to_wallet_id": "wal_def", "amount": 25000}'`,
