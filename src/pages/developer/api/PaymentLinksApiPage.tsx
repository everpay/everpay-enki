...
const PaymentLinksApiPage = () => (
  ...
  "created_at": "2026-03-25T12:00:00Z"
    ...
    <ApiEndpoint method="POST" path="/v2/payment-links" title="Create a Payment Link"
      ...
      code={{
        curl: `curl -X POST https://api.everpayinc.com/v2/payment-links \\
...
print(link.url)`,
  ...
  "active": true
    ...
    <ApiEndpoint method="GET" path="/v2/payment-links" title="List Payment Links"
      ...
      code={{
        curl: `curl "https://api.everpayinc.com/v2/payment-links?limit=10" \\
  -H "Authorization: Bearer sk_test_your_key"`,
  ...
  "url": "/v2/payment-links"
    ...
    <ApiEndpoint method="PATCH" path="/v2/payment-links/:id" title="Update a Payment Link"
      ...
      code={{
        curl: `curl -X PATCH https://api.everpayinc.com/v2/payment-links/plink_abc123 \\
  -H "Authorization: Bearer sk_test_your_key" \\
  -d '{"active": false}'`,
