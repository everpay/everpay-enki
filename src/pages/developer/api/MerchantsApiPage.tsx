...
const MerchantsApiPage = () => {
  return (
    <div className="max-w-4xl mx-auto space-y-10">
      ...
      <ApiEndpoint method="POST" path="/v2/merchants" title="Create a Merchant" description="Register a new merchant on the platform."
        params={[
      ...
      <ApiEndpoint method="GET" path="/v2/merchants" title="List Merchants" description="Retrieve a paginated list of merchants."
        params={[
        ...
        code={{
          curl: `curl "https://api.everpayinc.com/v2/merchants?limit=20&status=active" \\\n  -H "Authorization: Bearer sk_test_your_key"`,
