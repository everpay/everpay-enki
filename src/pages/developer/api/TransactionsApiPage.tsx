...
const TransactionsApiPage = () => {
  return (
    <div className="max-w-4xl mx-auto space-y-10">
      ...
      <ApiEndpoint method="GET" path="/v2/transactions" title="List Transactions" description="Retrieve a filtered list of transactions."
        params={[
        ...
        code={{
          curl: `curl "https://api.everpayinc.com/v2/transactions?status=succeeded&limit=25" \\\n  -H "Authorization: Bearer sk_test_your_key"`,
      ...
      <ApiEndpoint method="GET" path="/v2/transactions/:id" title="Retrieve a Transaction" description="Get full details of a specific transaction."
        params={[]}
        code={{
          curl: `curl https://api.everpayinc.com/v2/transactions/txn_abc123 \\\n  -H "Authorization: Bearer sk_test_your_key"`,
