...
const ProductsApiPage = () => {
  return (
    <div className="max-w-4xl mx-auto space-y-10">
      ...
      <ApiEndpoint method="POST" path="/v1/products" title="Create a Product" description="Create a new product."
        params={[
        ...
        code={{
          curl: `curl -X POST https://api.everpayinc.com/v1/products \\\n  -H "Authorization: Bearer sk_test_your_key" \\\n  -d '{"name": "Pro Plan", "description": "Full API access"}'`,
      ...
      <ApiEndpoint method="GET" path="/v1/products" title="List Products" description="Retrieve a paginated list of products."
        params={[{ name: "active", type: "boolean", required: false, desc: "Filter by active status" }]}
        code={{
          curl: `curl "https://api.everpayinc.com/v1/products?active=true" \\\n  -H "Authorization: Bearer sk_test_your_key"`,
