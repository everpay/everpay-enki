...
const CustomersApiPage = () => {
  return (
    <div className="max-w-4xl mx-auto space-y-10">
      ...
      <ApiEndpoint method="POST" path="/v2/customers" title="Create a Customer" description="Create a new customer record."
        params={[
        ...
        code={{
          curl: `curl -X POST https://api.everpayinc.com/v2/customers \\\n  -H "Authorization: Bearer sk_test_your_key" \\\n  -d '{"name": "Jane Doe", "email": "jane@example.com"}'`,
      ...
      <ApiEndpoint method="GET" path="/v2/customers" title="List Customers" description="Retrieve a paginated list of customers."
        params={[
        ...
        code={{
          curl: `curl "https://api.everpayinc.com/v2/customers?limit=20" \\\n  -H "Authorization: Bearer sk_test_your_key"`,
      ...
      <ApiEndpoint method="PATCH" path="/v2/customers/:id" title="Update a Customer" description="Update an existing customer's details."
        params={[
          { name: "name", type: "string", required: false, desc: "Updated name" },
          { name: "email", type: "string", required: false, desc: "Updated email" },
        ]}
        code={{
          curl: `curl -X PATCH https://api.everpayinc.com/v2/customers/cus_abc123 \\\n  -H "Authorization: Bearer sk_test_your_key" \\\n  -d '{"name": "Jane Smith"}'`,
      ...
      <ApiEndpoint method="DELETE" path="/v2/customers/:id" title="Delete a Customer" description="Permanently delete a customer."
        params={[]}
        code={{
          curl: `curl -X DELETE https://api.everpayinc.com/v2/customers/cus_abc123 \\\n  -H "Authorization: Bearer sk_test_your_key"`,
