...
export default function MerchantDisputes() {
  ...
  const renderList = (items: typeof disputes) => (
    items.length === 0 ? (
      <Card><CardContent className="flex flex-col items-center justify-center py-12"><Shield className="h-8 w-8 text-muted-foreground mb-2" /><p className="text-sm text-muted-foreground">No disputes found</p></CardContent></Card>
    ) : (
