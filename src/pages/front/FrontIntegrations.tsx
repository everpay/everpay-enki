...
const integrations: IntegrationItem[] = [
  // Accounting & ERP
  { name: "QuickBooks", description: "Simplify financial reporting and automate reconciliation with seamless ERP integrations.", category: "accounting", icon: "📊" },
  { name: "Xero", description: "Cloud-based financial tracking for growing businesses.", category: "accounting", icon: "📈" },
  { name: "SAP", description: "Enterprise-scale financial management and reporting.", category: "accounting", icon: "🏢" },
  { name: "NetSuite", description: "Connect ERP to your payment gateway for real-time insights.", category: "accounting", icon: "🔗" },
  // E-commerce
  { name: "Shopify", description: "Powerful e-commerce platform with seamless payment integration.", category: "ecommerce", icon: "🛍️" },
  { name: "WooCommerce", description: "Flexible payment solutions for your online store.", category: "ecommerce", icon: "🛒" },
  { name: "BigCommerce", description: "Enterprise e-commerce with advanced checkout experiences.", category: "ecommerce", icon: "🏪" },
  { name: "Magento", description: "Open-source e-commerce with customizable payment flows.", category: "ecommerce", icon: "🔶" },
  // Payment Gateways
  { name: "Mondo", description: "EU & UK card processing with multi-currency support.", category: "gateways", icon: "🇪🇺" },
  { name: "ShieldHub", description: "US & Global acquiring with advanced tokenization.", category: "gateways", icon: "🛡️" },
  { name: "Paygate10", description: "Emerging market coverage — India, Mexico, Pakistan, Brazil, Colombia.", category: "gateways", icon: "🌍" },
  { name: "Matrix Partners", description: "Gaming, casino & lottery processing — EUR/USD. Not available in the US.", category: "gateways", icon: "🎰" },
  { name: "DC Bank", description: "Canadian-only processing for domestic transactions.", category: "gateways", icon: "🇨🇦" },
  { name: "OFA Pay", description: "Asia-Pacific coverage with local payment methods.", category: "gateways", icon: "🌏" },
  { name: "Moneto", description: "Canadian digital wallet and payment solutions.", category: "gateways", icon: "💳" },
  { name: "Makapay", description: "Bangladesh market with mobile money support.", category: "gateways", icon: "🇧🇩" },
  { name: "Lipad.io", description: "African payment coverage — Kenya, Nigeria, South Africa.", category: "gateways", icon: "🌍" },
  { name: "PayOK", description: "Alternative payment methods for global coverage.", category: "gateways", icon: "✅" },
  { name: "PacoPay", description: "LATAM & emerging markets card processing.", category: "gateways", icon: "💰" },
  // CRM
  { name: "HubSpot", description: "Automate payment workflows to accelerate your sales pipeline.", category: "crm", icon: "🧡" },
  { name: "Salesforce", description: "Integrate payments in enterprise sales and service workflows.", category: "crm", icon: "☁️" },
  { name: "Pipedrive", description: "Payment tracking directly within your CRM deals.", category: "crm", icon: "📊" },
  // Banking & Treasury
  { name: "Plaid", description: "Secure bank account linking and financial data access.", category: "banking", icon: "🏦" },
  { name: "Wise", description: "Low-cost international payments with real FX rates.", category: "banking", icon: "💸" },
  { name: "Open Banking APIs", description: "Direct bank-to-bank transactions via open banking standards.", category: "banking", icon: "🔓" },
  { name: "Prometeo", description: "Latin American open banking and account connectivity.", category: "banking", icon: "🌎" },
  // Fraud & Risk
  { name: "Chargeflow", description: "Automated chargeback management and dispute resolution.", category: "fraud", icon: "🛡️" },
  { name: "Tapix", description: "Transaction enrichment and merchant intelligence.", category: "fraud", icon: "🔍" },
  { name: "3D Secure 2.0", description: "Strong customer authentication for card-not-present transactions.", category: "fraud", icon: "🔐" },
  // Developer Tools
