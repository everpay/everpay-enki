...
const integrations: Integration[] = [
  ...
  },
  {
    ...
    category: 'payments',
    status: 'connected',
    regions: ['CN', 'VN', 'TH', 'JP', 'KR', 'ID', 'MY', 'PH', 'HK', 'AU'],
  ...
  },
  {
    ...
    icon: Landmark,
    color: 'hsl(210 85% 45%)',
    docsUrl: 'https://clientdoc.dcbankapi.com/',
  },
  {
    id: 'makapay',
    name: 'MakaPay',
  ...
  },
  {
    ...
    category: 'payments',
    status: 'connected',
    regions: ['KE', 'TZ', 'UG', 'GH', 'ZA', 'NG', 'RW', 'ET'],
  ...
  // E-Commerce plugins
  {
    ...
    status: 'connected',
    regions: ['Global'],
    methods: ['Card', 'All supported methods'],
    icon: Globe,
    color: 'hsl(120 60% 40%)',
  },
  {
